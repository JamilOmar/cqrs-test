...
class Data extends CQRS.Events.EventHandler {
    constructor() {
        super();
    ...
    onLog(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this.reportDatabase.saveObjectInList('data-storage', data.eventVersion, data.eventVersion, data);
